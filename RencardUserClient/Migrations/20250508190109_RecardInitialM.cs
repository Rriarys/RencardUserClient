...
namespace RencardUserClient.Migrations
{
    /// <inheritdoc />
    public partial class RecardInitialM : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Alcohol = table.Column<string>(type: "text", nullable: false),
                    Religion = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutUsers", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "text", nullable: false),
                    Geography = table.Column<Point>(type: "geography (Point)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "text", nullable: false),
                    PreferredSex = table.Column<string>(type: "text", nullable: false),
                    MinPreferredAge = table.Column<int>(type: "integer", nullable: false),
                    MaxPreferredAge = table.Column<int>(type: "integer", nullable: false),
